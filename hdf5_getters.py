...
def get_similar_artists(h5,songidx=0):
    ...
    return numpy.array(h5.root.metadata.similar_artists[h5.root.metadata.songs.cols.idx_similar_artists[songidx]:
...
def get_artist_terms(h5,songidx=0):
    ...
    return numpy.array(h5.root.metadata.artist_terms[h5.root.metadata.songs.cols.idx_artist_terms[songidx]:
...
def get_artist_terms_freq(h5,songidx=0):
    ...
    return numpy.array(h5.root.metadata.artist_terms_freq[h5.root.metadata.songs.cols.idx_artist_terms[songidx]:
                                              h5.root.metadata.songs.cols.idx_artist_terms[songidx+1]])
...
def get_artist_terms_weight(h5,songidx=0):
    ...
    return numpy.array(h5.root.metadata.artist_terms_weight[h5.root.metadata.songs.cols.idx_artist_terms[songidx]:
                                                h5.root.metadata.songs.cols.idx_artist_terms[songidx+1]])
...
def get_segments_start(h5,songidx=0):
    ...
    return numpy.array(h5.root.analysis.segments_start[h5.root.analysis.songs.cols.idx_segments_start[songidx]:
...
def get_segments_confidence(h5,songidx=0):
    ...
    return numpy.array(h5.root.analysis.segments_confidence[h5.root.analysis.songs.cols.idx_segments_confidence[songidx]:
...
def get_segments_pitches(h5,songidx=0):
    ...
    return numpy.array(h5.root.analysis.segments_pitches[h5.root.analysis.songs.cols.idx_segments_pitches[songidx]:
...
def get_segments_timbre(h5,songidx=0):
    ...
    return numpy.array(h5.root.analysis.segments_timbre[h5.root.analysis.songs.cols.idx_segments_timbre[songidx]:
...
def get_segments_loudness_max(h5,songidx=0):
    ...
    return numpy.array(h5.root.analysis.segments_loudness_max[h5.root.analysis.songs.cols.idx_segments_loudness_max[songidx]:
...
def get_segments_loudness_max_time(h5,songidx=0):
    ...
    return numpy.array(h5.root.analysis.segments_loudness_max_time[h5.root.analysis.songs.cols.idx_segments_loudness_max_time[songidx]:
...
def get_segments_loudness_start(h5,songidx=0):
    ...
    return numpy.array(h5.root.analysis.segments_loudness_start[h5.root.analysis.songs.cols.idx_segments_loudness_start[songidx]:
...
def get_sections_start(h5,songidx=0):
    ...
    return numpy.array(h5.root.analysis.sections_start[h5.root.analysis.songs.cols.idx_sections_start[songidx]:
...
def get_sections_confidence(h5,songidx=0):
    ...
    return numpy.array(h5.root.analysis.sections_confidence[h5.root.analysis.songs.cols.idx_sections_confidence[songidx]:
...
def get_beats_start(h5,songidx=0):
    ...
    return numpy.array(h5.root.analysis.beats_start[h5.root.analysis.songs.cols.idx_beats_start[songidx]:
...
def get_beats_confidence(h5,songidx=0):
    ...
    return numpy.array(h5.root.analysis.beats_confidence[h5.root.analysis.songs.cols.idx_beats_confidence[songidx]:
...
def get_bars_start(h5,songidx=0):
    ...
    return numpy.array(h5.root.analysis.bars_start[h5.root.analysis.songs.cols.idx_bars_start[songidx]:
...
def get_bars_confidence(h5,songidx=0):
    ...
    return numpy.array(h5.root.analysis.bars_confidence[h5.root.analysis.songs.cols.idx_bars_confidence[songidx]:
...
def get_tatums_start(h5,songidx=0):
    ...
    return numpy.array(h5.root.analysis.tatums_start[h5.root.analysis.songs.cols.idx_tatums_start[songidx]:
...
def get_tatums_confidence(h5,songidx=0):
    ...
    return numpy.array(h5.root.analysis.tatums_confidence[h5.root.analysis.songs.cols.idx_tatums_confidence[songidx]:
...
def get_artist_mbtags(h5,songidx=0):
    ...
    return numpy.array(h5.root.musicbrainz.artist_mbtags[h5.root.metadata.songs.cols.idx_artist_mbtags[songidx]:
...
def get_artist_mbtags_count(h5,songidx=0):
    ...
    return numpy.array(h5.root.musicbrainz.artist_mbtags_count[h5.root.metadata.songs.cols.idx_artist_mbtags[songidx]:
                                                   h5.root.metadata.songs.cols.idx_artist_mbtags[songidx+1]])
